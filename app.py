...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {VA_BLUE}; font-size: 3rem; margin-bottom: 10px;">VERA-VA</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results &amp; Accountability<br>Virginia Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-VA", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-VA analyzes ACCESS for ELLs domain data and SOL results across Virginia school divisions.</p>
        <p>~145,000 English Learners | 25-30+ pt White-Black SOL gap | HB 1186/SB 394 AI guidance (2026)</p>
